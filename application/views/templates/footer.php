  			...
  			<div class="page-header">
  			  <div class="row">	
  				...
  				<div class="col-xs-6 col-md-4">
  				  <ul class="nav">
              <li class="horizontal-lists"><a href="#" class="header-title" style="font-size:14px;">FAQ</a></li> 
              <li class="horizontal-lists"><a href="#" class="header-title" style="font-size:14px;">Terms of Use</a></li>
              <li class="horizontal-lists"><a href="#" class="header-title" style="font-size:14px;">Privacy Policy</a></li>
            </ul> 
  				</div>
  			  </div>	
			</div>
    ...
    <div class="container-fluid row-background">    
      <div class="container">  
        <div class="row"> 
          ...
          <div class="col-xs-6 col-md-4"><p>Web Design & Development by Sina Unuigbe</p></div>
          <div class="col-xs-6 col-md-4">
