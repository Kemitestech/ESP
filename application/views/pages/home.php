<div id ="home-hero" class="slider1 jumbotron jumbo-slider-override hero-hover">
  ...
  <div class="jumbotron contact-background reset-jumb-pos">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <p>The Church is well known with Parishes, Dioceses all over the world with its International Headquarters in Nigeria.  See Celestial History for Brief History of the Church.
