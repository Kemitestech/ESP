    ...
    <div class="container">
        <form class="form-horizontal col-sm-10 col-sm-offset-3">
          ...
          <label class="col-sm-9">
            <h1 class="header-title">Make a Prayer Request</h1>
            <p>The power of prayer should never be under estimated. Let us help you in whatever circumstance. Use the form below for your prayer request and leave the rest to our Lord who never fails.
          ...
          <div class="form-group input-margin">
           <div class="col-sm-9"> 
            <textarea id="InputRequest" class="form-control no-radius input-lg" name="Request" placeholder="Request *" rows="3"></textarea>
           </div> 
          </div> 
          <div class="form-group">
            <div class="col-sm-9"> 
