    ...
    <div class="container">
       ...
       <div class="row"><!--Start of row-->
        <div class="content" data-spy="scroll" data-target="navbar-example" data-offset="5">
         <div class="col-md-9" id="mainCol-coc">
      
          <h1 id="sec0"><small>Coming Soon</small></h1>
          <p>Celestial Church of Christ is a spiritual, world-wide, united, indivisible Holy Church which came into the world from heaven by DIVINE ORDER on the 29th of September 1947 in Porto Novo, Republic of Benin through the founder of the Church, the Late Reverend, Pastor, Prophet, Founder Samuel Bilehou Joseph Oshoffa. The Church is well known with Parishes, Dioceses all over the world with its International Headquarters in Nigeria.  See Celestial History for Brief History of the Church.</p>
          <hr>
          <h1 id="sec1"><small>Coming Soon</small></h1>
          ...
          <hr>
          <h1 id="sec2"><small>Coming Soon</small></h1>
          <p>In the deep mystery of divine appearance, during prayer on the 19th September 1947, a winged Angel bathed in intense light, word came from God to the founder as follows: <br><br>"It is the wish of God to send you on an errand of preaching into the World.   Many nominal Christians there who were confronted by difficulties and problems of this world.  They run after fetish priests and other power of darkness for all kinds of assistance.  Consequently, on their death, they cannot see Christ because, by their action, Satan has left his spiritual mark on them.  To assist you in in your work so that men may listen to the fact that God has sent you."</p>
          <hr>
          <h1 id="sec3"><small>Coming Soon</small></h1>
          <p>
          The Church under the absolute dictatorship of Holy Spirit is hereby emphasized for:<br><br>
          <b>The Name of the Church:</b><br><br>
         ...
         <div class="col-md-3" id="navbar-example">
              <ul class="nav nav-stacked" id="sidebar">
                ...
                <li><a href="#sec3">Tenet and Mode of Worship</a></li>
                <li><a href="#sec4">Holy Rites or Sacraments</a></li>
