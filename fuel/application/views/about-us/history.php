           ...
           <div class="row"><!--Start of row-->
            <div class="content" data-spy="scroll" data-target="navbar-example" data-offset="5">
             <div class="col-md-9" id="mainCol">
                 ...
                 <div class="modal-content" style="text-align: center;"><!--Start of modal-content-->
                    ...
                    <div class="row"><!--Start of row-->
                     <div class="col-md-8 col-md-offset-2">
                       <div class="thumbnail">
                        <img src="img/sbjcolor.gif" class="img-responsive" alt="Image" style="width: 100%;">
                          <div class="caption" >
                            <h4 class="header-title">Rev. S.B.J. Oshoffa Prophet, Pastor, Founder C.C.C. Worldwide <br>(1909 - 1985)</h4>
                          </div>
                       </div>
                     </div>
                    </div><!--End of row-->
              ...
              <hr>
              <h1 id="sec2"><small>The Spiritual Message</small></h1>
              ...
              <hr>
              <h1 id="sec3"><small>Tenet and Mode of Worship</small></h1>
              <p>
              ...
              <hr>
              <h1 id="sec4"><small>Holy Rites or Sacraments</small></h1>
              ...
              <hr>
              <h1 id="sec5"><small>Membership</small></h1>
